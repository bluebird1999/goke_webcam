...
static config_map_t config_profile_map[] = {
        ...
        {"motion_detect_sensitivity", &(config.motion_detect_sensitivity),           cfg_u8,     "3",                        0, 5,},
        ...
        {"recorder_enable",           &(config.recorder_enable),                     cfg_u8,     "3",                        0, 3,},
        ...
        {"debug02",                 &(config.debug[2]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug03",                 &(config.debug[3]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug04",                 &(config.debug[4]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug05",                 &(config.debug[5]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug06",                 &(config.debug[6]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug07",                 &(config.debug[7]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug08",                 &(config.debug[8]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug09",                 &(config.debug[9]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug10",                 &(config.debug[10]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug11",                 &(config.debug[11]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug12",                 &(config.debug[12]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug13",                 &(config.debug[13]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug14",                 &(config.debug[14]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug15",                 &(config.debug[15]),                         cfg_s32,     "0",                        -1000000, 1000000},
        {"debug16",                 &(config.debug[16]),                         cfg_s32,     "0",                        -1000000, 1000000},

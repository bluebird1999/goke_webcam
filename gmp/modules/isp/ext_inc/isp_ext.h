...
typedef struct ISP_BUS_CALLBACK_S {
    GK_S32 (*pfnISPWriteI2CData) (GK_U8 u8I2cDev, GK_U8 u8DevAddr, GK_U32 u32RegAddr,
                                  GK_U32 u32RegAddrByteNum, GK_U32 u32Data, GK_U32 u32DataByteNum);
    GK_S32 (*pfnISPWriteSSPData) (GK_U32 u32SpiDev, GK_U32 u32SpiCsn,
                                  GK_U32 u32DevAddr, GK_U32 u32DevAddrByteNum,
                                  GK_U32 u32RegAddr, GK_U32 u32RegAddrByteNum, GK_U32 u32Data, GK_U32 u32DataByteNum);
} ISP_BUS_CALLBACK_S;
...
typedef struct ISP_EXPORT_FUNC_S {
    GK_S32 (*pfnISPRegisterBusCallBack) (GK_S32 ViPipe, ISP_BUS_TYPE_E enType, ISP_BUS_CALLBACK_S *pstBusCb);
    GK_S32 (*pfnISPRegisterPirisCallBack) (GK_S32 ViPipe, ISP_PIRIS_CALLBACK_S *pstPirisCb);
    GK_S32 (*pfnISPRegisterViBusCallBack) (GK_S32 ViPipe, ISP_VIBUS_CALLBACK_S *pstViBusCb);
    ...
    GK_S32 (*pfnISP_GetIspUpdateInfo)(VI_PIPE ViPipe, ISP_DCF_UPDATE_INFO_S *pstIspUpdateInfo);
    GK_S32 (*pfnISP_SetIspUpdateInfo)(VI_PIPE ViPipe, ISP_DCF_UPDATE_INFO_S *pstIspUpdateInfo);
    GK_S32 (*pfnISP_GetFrameInfo)(VI_PIPE ViPipe, ISP_FRAME_INFO_S *pstIspFrame);
    GK_S32 (*pfnISP_SetFrameInfo)(VI_PIPE ViPipe, ISP_FRAME_INFO_S *pstIspFrame);
    GK_S32 (*pfnISP_GetAttachInfo)(VI_PIPE ViPipe, ISP_ATTACH_INFO_S *pstIspAttachInfo);
    GK_S32 (*pfnISP_GetColorGamutInfo)(VI_PIPE ViPipe, ISP_COLORGAMMUT_INFO_S *pstIspColorGamutInfo);
    GK_S32 (*pfnISP_GetDngImageDynamicInfo)(VI_PIPE ViPipe, DNG_IMAGE_DYNAMIC_INFO_S *pstDngImageDynamicInfo);
    GK_S32 (*pfnISP_SaveSnapConfig)(VI_PIPE ViPipe, ISP_CONFIG_INFO_S *pstSnapInfo);
    GK_S32 (*pfnISP_SetProEnable)(VI_PIPE ViPipe);
    GK_S32 (*pfnISP_DRV_GetReadyBeBuf)(VI_PIPE ViPipe, ISP_BE_WO_CFG_BUF_S *pstBeCfgBuf);
    GK_S32 (*pfnISP_DRV_PutFreeBeBuf)(VI_PIPE ViPipe, ISP_BE_WO_CFG_BUF_S *pstBeCfgBuf);
    GK_S32 (*pfnISP_DRV_HoldBusyBeBuf)(VI_PIPE ViPipe, ISP_BE_WO_CFG_BUF_S *pstBeCfgBuf);
    GK_S32 (*pfnISP_DRV_GetBeSyncPara)(VI_PIPE ViPipe, ISP_BE_SYNC_PARA_S *pstBeSyncPara);
    GK_BOOL (*pfnISP_GetProCtrl)(VI_PIPE ViPipe, ISP_PRO_CTRL_S *pstProCtrl);
    GK_S32 (*pfnISP_SetSnapAttr)(VI_PIPE ViPipe, ISP_SNAP_ATTR_S *pstSnapAttr);
    GK_S32 (*pfnISP_SetProNrParam )(VI_PIPE ViPipe, const ISP_PRO_BNR_PARAM_S *pstProNrParam);
    GK_S32 (*pfnISP_SetProShpParam )(VI_PIPE ViPipe, const ISP_PRO_SHARPEN_PARAM_S *pstProShpParam);
    GK_S32 (*pfnISP_GetProNrParam )(VI_PIPE ViPipe, ISP_PRO_BNR_PARAM_S *pstProNrParam);
    GK_S32 (*pfnISP_GetProShpParam )(VI_PIPE ViPipe, ISP_PRO_SHARPEN_PARAM_S *pstProShpParam);
    GK_S32 (*pfnISP_DRV_BeEndIntProc)(VI_PIPE ViPipe);
    GK_S32 (*pfnISPRegisterSyncTask)(VI_PIPE ViPipe, ISP_SYNC_TASK_NODE_S *pstNewNode);
    GK_S32 (*pfnISPUnRegisterSyncTask)(VI_PIPE ViPipe, ISP_SYNC_TASK_NODE_S *pstDelNode);
    ...
    GK_S32 (*pfnISP_DRV_GetRgbirFormat)(VI_PIPE ViPipe, ISP_IRBAYER_FORMAT_E *pRgbirFormat);
    GK_S32 (*pfnISP_DRV_SetOnLineStaticsSttAddr)(VI_PIPE ViPipe,GK_U32 u32ViprocIrqStatus);
} ISP_EXPORT_FUNC_S;
...
extern GK_S32 isp_sync_task_register(VI_PIPE ViPipe, ISP_SYNC_TASK_NODE_S *pstNewNode);
extern GK_S32 isp_sync_task_unregister(VI_PIPE ViPipe, ISP_SYNC_TASK_NODE_S *pstDelNode);

...
static char __initdata setup_zones[MMZ_SETUP_CMDLINE_LEN] = CONFIG_VENDOR_MMZ_DEFAULT;
...
mmz_mmz_t *mmz_mmz_create_v2(const char *name,
        unsigned long gfp,
        unsigned long phys_start,
        unsigned long nbytes,
...
mmz_mmb_t *mmz_mmb_alloc_v2(const char *name,
            unsigned long size,
            unsigned long align,
            unsigned long gfp,
            const char *mmz_name,
...
mmz_mmb_t *mmz_mmb_alloc_in(const char *name,
            unsigned long size,
            unsigned long align,
            mmz_mmz_t *_user_mmz)
{
...
mmz_mmb_t *mmz_mmb_alloc_in_v2(const char *name,
            unsigned long size,
            unsigned long align,
            mmz_mmz_t *_user_mmz,
            unsigned int order)
